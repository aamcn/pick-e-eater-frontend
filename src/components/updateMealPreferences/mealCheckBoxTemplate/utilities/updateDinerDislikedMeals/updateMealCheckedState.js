export function updateMealCheckedState(selectedDiner, meal, setIsChecked) {
  if (!meal ) {
    throw new Error("Invalid arguments provided to updateMealCheckedState, meal is required");
  }
  if (!selectedDiner ) {
    throw new Error("Invalid arguments provided to updateMealCheckedState, selectedDiner is required");
  }
