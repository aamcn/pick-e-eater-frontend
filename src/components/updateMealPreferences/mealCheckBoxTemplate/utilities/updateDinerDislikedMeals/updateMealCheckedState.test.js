...
describe("updateMealCheckedState", () => {
  ...
  it("should throw error if selectedDiner is null or undefined", () => {
    expect(() => updateMealCheckedState(null, meal, setIsChecked)).toThrow("Invalid arguments provided to updateMealCheckedState, selectedDiner is required");
    expect(() => updateMealCheckedState(undefined, meal, setIsChecked)).toThrow("Invalid arguments provided to updateMealCheckedState, selectedDiner is required");
  });   

  it("should throw error if meal is null or undefined", () => {
    expect(() => updateMealCheckedState(selectedDiner, null, setIsChecked)).toThrow("Invalid arguments provided to updateMealCheckedState, meal is required");
    expect(() => updateMealCheckedState(selectedDiner, undefined, setIsChecked)).toThrow("Invalid arguments provided to updateMealCheckedState, meal is required");
  });

  it("should throw error if setIsChecked is not a function", () => {
    expect(() => updateMealCheckedState(selectedDiner, meal, null)).toThrow("setIsChecked must be a function");
    expect(() => updateMealCheckedState(selectedDiner, meal, undefined)).toThrow("setIsChecked must be a function");
    expect(() => updateMealCheckedState(selectedDiner, meal, "notAFunction")).toThrow("setIsChecked must be a function");
  });
