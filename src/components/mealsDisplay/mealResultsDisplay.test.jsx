...
const mockProps = {
  filteredMeals: [
    { id: 1, name: "Pizza", type: "Italian", sub_type: "Main Course", difficulty: "Easy" }, 
    { id: 2, name: "Sushi", type: "Japanese", sub_type: "Main Course", difficulty: "Medium" }
  ],
};
...
describe("MealResultsDisplay", () => {
  ...
  it("renders the list items with correct values", () => {
    ...
    expect(listEntry1.firstChild.nextSibling.textContent).toBe('Italian | Main Course | Easy');
    expect(listEntry2.firstChild.textContent).toBe('Sushi');
    expect(listEntry2.firstChild.nextSibling.textContent).toBe('Japanese | Main Course | Medium');
  });
