...
const mockProps = { 
    filteredMeals: [
        { id: 1, name: "Spaghetti", type: "Italian", sub_type: "Pasta", difficulty: "Medium" }, 
        { id: 2, name: "Burger", type: "American", sub_type: "Main", difficulty: "Easy" }, 
        { id: 3, name: "Salad", type: "Healthy", sub_type: "Side", difficulty: "Easy" }
    ],
