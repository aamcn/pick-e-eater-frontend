...
describe("tickedBox Module", () => {
    ...
    it("should call setIsClicked with true when isClicked is false", () => {
        tickedBox(mockArguments.selectedDiners, mockArguments.setIsClicked, mockArguments.isClicked, mockArguments.diner, mockArguments.setSelectedDiners);
        expect(mockArguments.setIsClicked).toHaveBeenCalledWith(true);

    })

    it("should call setIsClicked with false when isClicked is true", () => {
        tickedBox(mockArguments.selectedDiners, mockArguments.setIsClicked, true, mockArguments.diner, mockArguments.setSelectedDiners);
    ...
    it("should remove diner from selectedDiners when isClicked is true", () => {
        tickedBox(mockArguments.selectedDiners, mockArguments.setIsClicked, true, mockArguments.diner, mockArguments.setSelectedDiners);
        expect(mockArguments.setSelectedDiners).toHaveBeenCalledWith([{ id: 1, name: "Diner 1" }]);
    })
